...
@app.route('/Files')
def Files():
   file_list = download_hndlr.get_downloadable_all_files()
   return file_list


@app.route('/getFiles/<file_name>')
def getFile(file_name):
   return send_file(download_hndlr.getDownloadFolderPath()+"\\"+file_name) 
...
def runServer():
   ...
   if(mode=="dev"):
      ...
      sys.stdout.flush()
      serve(app,host=server_detail.HOST,port=server_detail.PORT,threads=10)
